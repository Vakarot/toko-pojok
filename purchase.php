                                ...
                                <tr>
                                    <td colspan="14">
                                        <div class="empty-state">
                                            ...
                                            <h5 class="mb-2">Belum ada data purchase order</h5>
                                            <p class="text-muted mb-3">Mulai dengan menambahkan purchase order pertama Anda</p>
                                            <a href="input_purchase.php" class="btn btn-primary">
